...
class CategoriesOrm(Base):
    ...
    status: Mapped[StatusTypes] = mapped_column(
        PgEnum(StatusTypes, name="status_types", create_type=True)
    )
    type: Mapped[CategoriesTypes] = mapped_column(
        PgEnum(CategoriesTypes, name="categories_types", create_type=True)
    )
    title: Mapped[str]
