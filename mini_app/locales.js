...
window.MINI_APP_LOCALES = {
    "ru": {
        ...
        "errors": {
            ...
            "receipt_not_ready": "Касса ещё не передала состав чека в налоговую. Повторите через пару минут.",
    ...
    "en": {
        ...
        "errors": {
            ...
            "receipt_not_ready": "The till hasn't sent the receipt's items to the tax service yet. Try again in a couple of minutes.",
    ...
    "hi": {
        ...
        "errors": {
            ...
            "receipt_not_ready": "कैश रजिस्टर ने अभी तक रसीद की वस्तुएँ कर विभाग को नहीं भेजी हैं। कुछ मिनट बाद फिर कोशिश करें।",
    ...
    "es": {
        ...
        "errors": {
            ...
            "receipt_not_ready": "La caja todavía no ha enviado los artículos del recibo a la agencia tributaria. Inténtalo de nuevo en un par de minutos.",
    ...
    "fr": {
        ...
        "errors": {
            ...
            "receipt_not_ready": "La caisse n'a pas encore transmis le détail du ticket au fisc. Réessayez dans quelques minutes.",
