class SpreadSheetSetStyler:
    ...
    def setStyleBaseLists(self, spreadsheetID):
        ...
        reqData = []
        for z, i in enumerate(
            [len(startSheets["Categories"][0]), len(startSheets["Bills"][0])]
        ):
            reqData.append(
                {
                    "repeatCell": {
    ...
    def setStyleTotalLists(
        self, spreadsheetID, sheetId, daysCurMonth, incomeRows, costRows
    ):
        reqData = []
        reqData.append(
            {
