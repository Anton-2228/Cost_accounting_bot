...
class Spreadsheet:
    ...
    def createTable(self, title, email):
        ...
        spreadsheet = self.sheetService.spreadsheets().create(body={
    ...
    def addNewOperationsSheet(self, spreadsheetID, currentMonth):
        ...
        self.spreadSheetSetStyler.setStyleOperationLists(spreadsheetID, sheets[str(currentMonth)])
        self.spreadSheetSetStyler.setSecurityOperationLists(spreadsheetID, sheets[str(currentMonth)])
    ...
    def addNewStatisticsSheet(self, spreadsheetID, currentMonth, count_days):
        ...
        sheets = self.getSheets(spreadsheetID)
        self.spreadSheetSetStyler.setStyleStatisticsLists(spreadsheetID, sheets["Stat. " + str(currentMonth)], days)
        self.spreadSheetSetStyler.setSecurityStatisticsLists(spreadsheetID, sheets["Stat. " + str(currentMonth)], days)
    ...
    def setWidthColumn(self, spreadsheetID, data):
        ...
        results = self.sheetService.spreadsheets().batchUpdate(spreadsheetId=spreadsheetID, body={
            "requests": reqData
        }).execute()
    ...
    def setValues(self, spreadsheetID, data):
        ...
        results = self.sheetService.spreadsheets().values().batchUpdate(spreadsheetId=spreadsheetID, body={
