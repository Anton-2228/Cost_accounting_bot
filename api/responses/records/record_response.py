...
class RecordResponse(BaseModel):
    ...
    в `currency` — валюте самой операции. Приведённой к какой-либо общей валюте
    суммы здесь нет: она зависит от курса на день операции и считается только
    для листа статистики.
