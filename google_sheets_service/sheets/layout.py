...
class SheetLayout:
    ...
    #: Защитить лист целиком. Так закрыты реестр операций и статистика: они
    #: производны от базы, и правка в них была бы потеряна следующей же
    #: перерисовкой — молча и без объяснений.
